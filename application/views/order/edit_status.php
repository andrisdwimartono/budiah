...
function update_progress(){
	...
	function ctoGetProgressBar(cto_elementid, cto_elementid2, addr, param){ 
		...
		var prog = "<div class=\"progress-bar progress-bar-success\" role=\"progressbar\" style=\"width:"+progress_bar['percentage']+"%\">"
								...
								+"</div>"
								+"<div class=\"progress-bar progress-bar-striped active\" role=\"progressbar\" aria-valuenow=\"40\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width:"+(progress_bar['percentage_onwork']-progress_bar['percentage'])+"%\">"
								+""+(progress_bar['percentage_onwork']-progress_bar['percentage'])+"% On work ("+progress_bar['status_next']+")"
								+"</div>"
